...
// const APP_ID = 'ce8572ae-ff57-4e77-a265-5c91f00ecc4c'; // original
// const APP_ID = 'aab9c276-832e-4f54-a428-097f70df80db';
  ...
  async componentDidMount() {
    ...
    OneSignal.Notifications.setNotificationWillShowInForegroundHandler(
      (notifReceivedEvent) => {
        ...
        Alert.alert('Complete notification?', 'Test', [cancelButton, completeButton], {
          cancelable: true,
        });
      },
    );
