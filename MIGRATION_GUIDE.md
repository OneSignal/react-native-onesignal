...
| `OneSignal.User.getOnesignalId()`                                                                  | _Returns the nullable OneSignal ID for the current user._|
| `OneSignal.User.getExternalId()`                                                                  | _Returns the nullable external ID for the current user._|
